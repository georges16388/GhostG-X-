...
module.exports = {
  name: 'antitagall', // Nom mis à jour ici
  aliases: ['agm', 'antitag'],
  category: 'admin',
  description: 'Configure la protection contre les mentions de groupe (@everyone/@all).',
  usage: '.antitagall on/off | .antitagall set delete/kick',
  groupOnly: true,
  adminOnly: true,
  ...
  async execute(sock, msg, args, { from, react, reply }) {
    try {
      ...
      return reply(`⚠️ *${toStyledCaps('ᴜsᴀɢᴇ')}* : *.antitagall ᴏɴ | ᴏꜰꜰ | sᴇᴛ ᴅᴇʟᴇᴛᴇ/ᴋɪᴄᴋ*`);
