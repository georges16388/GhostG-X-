...
module.exports = {
  name: 'ɪᴍᴀɢᴇ',
  aliases: ['toimg', 'stickertoimg', 'sticker2img', 'svideo','image', 'simage', 'img'],
  category: '☬ᴄᴏᴅᴇx ᴇᴛ ʀɪᴛᴜᴇʟs',
  description: '**ᴄᴏɴᴠᴇʀᴛɪꜱ ᴜɴ ꜱᴛɪᴄᴋᴇʀ ᴇɴ ɪᴍᴀɢᴇ (ᴘɴɢ) ᴏᴜ ᴇɴ ᴠɪᴅᴇ́ᴏ**',
  usage: 'ɪᴍᴀɢᴇ',

  async execute(sock, msg, args, extra) {
    try {
      const notStickerMessage = `⌘ ʀᴇ́ᴘᴏɴᴅᴇᴢ ᴀ̀ ᴜɴ sᴛɪᴄᴋᴇʀ ᴘᴏᴜʀ ᴇ́ɴᴇɴᴄʜᴇʀ ʟ'ɪᴍᴀɢᴇ ᴅ'ᴏʀɪɢɪɴᴇ.`;
      ...
      if (!stickerBuffer) {
        return await extra.reply(`〆 ᴇ́ᴄʜᴇᴄ ᴅᴇ ʟ'ɪɴᴠᴏᴄᴀᴛɪᴏɴ : ɪᴍᴘᴏssɪʙʟᴇ ᴅᴇ sᴀɪsɪʀ ʟᴇ sᴛɪᴄᴋᴇʀ. ʀᴇᴇssᴀʏᴇᴢ`);
      }
      ...
      await extra.reply(`❌ *ᴇ́ᴄʜᴇᴄ ᴅᴇ ʟᴀ ᴄᴏɴᴠᴇʀsɪᴏɴ ᴅᴜ sᴛɪᴄᴋᴇʀ.*\n\n*ᴇʀʀᴇᴜʀ :* ${error.message}\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɢʜᴏsᴛɢ-𝐗*`);
    }
  }
};
