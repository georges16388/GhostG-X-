...
module.exports = {
  ...
  description: 'Invoque la sagesse des langues pour traduire un murmure',
  usage: '.tr <langue> <texte> ou .tr <langue> en répondant à un message',
    ...
    try { 
      ...
      if (quoted) {
        ...
        if (args.length >= 2) {
          ...
          // Si un seul mot, on traduit vers le français par défaut
          targetLang = 'fr';
          text = args.join(' ');
        }
      }
