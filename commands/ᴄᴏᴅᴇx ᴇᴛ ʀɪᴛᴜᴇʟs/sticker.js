...
module.exports = {
  name: 'sᴄᴇᴀᴜ',
  aliases: ['s', 'stiker', 'stc', 'sceau'],
  description: 'Convertis une image ou une video en sticker (auto compression)',
  usage: '.sᴄᴇᴀᴜ (reply to media)',
  ...
  async execute(sock, msg, args, extra) {
    ...
    if (!mediaMessage) {
      return extra.reply(`*〆 ʀᴇ́ᴘᴏɴᴅᴇᴢ ᴀ̀ ᴜɴᴇ ɪᴍᴀɢᴇ / ᴠɪᴅᴇ́ᴏ ᴀᴠᴇᴄ ${prefix}sᴄᴇᴀᴜ ᴏᴜ ᴇɴᴠᴏʏᴇᴢ ʟᴇ ᴍᴇ́ᴅɪᴀ ᴀᴠᴇᴄ ${sᴄᴇᴀᴜ} ᴇɴ ʟᴇ́ɢᴇɴᴅᴇ*\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɢʜᴏsᴛɢ-𝐗*`);
    }
    ...
    try {
      ...
      if (!mediaBuffer) {
        await extra.reply(`*〆 ᴇ́ᴄʜᴇᴄ ᴅᴇ ʟᴀ ᴄʀᴇ́ᴀᴛɪᴏɴ : ᴀssᴜʀᴇᴢ-ᴠᴏᴜs ǫᴜᴇ ʟᴇ ᴍᴇ́ᴅɪᴀ ᴇsᴛ ᴠᴀʟɪᴅᴇ*`);
        return;
      }
