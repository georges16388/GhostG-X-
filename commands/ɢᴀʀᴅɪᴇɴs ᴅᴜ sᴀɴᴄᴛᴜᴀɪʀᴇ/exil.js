  ...
  async execute(sock, msg, args, extra) {
    ...
    try {
      ...
      if (isTryingToKickBot) {
        return extra.reply('*❌ L\'arcane ne peut pas s\'auto-bannir du sanctuaire !*');
      }
      ...
      await extra.reply('*❌ Échec du bannissement. Assure-toi que je sois bien administrateur du groupe.*');
    }
  },
};
