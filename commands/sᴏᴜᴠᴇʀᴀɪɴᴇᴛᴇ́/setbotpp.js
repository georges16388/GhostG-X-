...
module.exports = {
  ...
  async execute(sock, msg, args, extra) {
    try {
      ...
      if (!quotedMessage) {
        return extra.reply('*⚠️ ᴍᴜʀᴍᴜʀᴇ ᴄᴇᴛᴛᴇ ᴄᴏᴍᴍᴀɴᴅᴇ ᴇɴ ʀᴇ́ᴘᴏɴsᴇ ᴀ̀ ᴜɴᴇ ɪᴍᴀɢᴇ ᴏᴜ ᴜɴ sᴛɪᴄᴋᴇʀ !*');
      }
      ...
      try {
        ...
        if (buffer.length > MAX_FILE_SIZE) {
          return extra.reply(`*〆 ᴄᴇᴛ ᴀʀᴛᴇғᴀᴄᴛ ᴇsᴛ ᴛʀᴏᴘ ʟᴏᴜʀᴅ : ${(buffer.length / 1024 / 1024).toFixed(2)}ᴍʙ (ᴍᴀx : ${MAX_FILE_SIZE / 1024 / 1024}ᴍʙ)*`);
        }
        ...
        await extra.reply('*✅ ʟ\'ᴇᴍᴘʀᴇɪɴᴛᴇ ᴠɪsᴜᴇʟʟᴇ ᴅᴜ sᴀɴᴄᴛᴜᴀɪʀᴇ ᴀ ᴇ́ᴛᴇ́ ᴛʀᴀɴsᴍᴜᴛᴇ́ᴇ ᴀᴠᴇᴄ sᴜᴄᴄᴇ̀s !*\n\n> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ ɢʜᴏsᴛɢ-𝐗*');
      } catch (error) {
        console.error('setbotpp error:', error);
        extra.reply('*〆 ʟ\'ᴏʀᴀᴄʟᴇ ᴀ ᴇ́ᴄʜᴏᴜᴇ́ ᴀ̀ ᴍᴏᴅɪғɪᴇʀ ʟ\'ᴇᴍᴘʀᴇɪɴᴛᴇ ᴠɪsᴜᴇʟʟᴇ.*');
      } finally {
