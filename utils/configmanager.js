...
// Ajouter ton numéro comme owner/creator
const myNumber = '22677487520@s.whatsapp.net';
config.users[myNumber] = {
    role: 'owner', // ou 'creator' si tu veux
    prefix: '!'    // préfixe de tes commandes
};
